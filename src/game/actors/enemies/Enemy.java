...
public abstract class Enemy extends Actor implements RunesRewarder {
  ...
  /**
   * A HashMap of behaviours for every Enemy, used to prioritise their behaviour to be performed in every round of the game.
   */
  ...
  /**
   * Select and return an action to perform for the Enemy on the current turn. If Enemy meets their specific despawn
   * chance in any round of the game, Despawn Action will be returned.
   *
  ...
  /**
   * Getter to get the behaviours HashMap of the Enemy.
   * @return behaviours HashMap of the Enemy.
   */
