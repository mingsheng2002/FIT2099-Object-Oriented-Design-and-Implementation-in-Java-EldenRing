package game.actors.enemies.stormveilcastleinhabitants;
...
/**
 * A class representing the Stormveil Castle inhabitant enemy.
 * Created by:
 ...
 * @see Enemy
 */
public abstract class StormveilCastleInhabitant extends Enemy {

    /**
     * Constructor for StormveilCastleInhabitant.
     ...
     * @see Status#FRIENDLY_TO_STORMVEIL_CASTLE_INHABITANT
     */
    public StormveilCastleInhabitant(String name, char displayChar, int hitPoints, int spawnChance, int despawnChance, int minRunes, int maxRunes) {
        super(name, displayChar, hitPoints, spawnChance, despawnChance, minRunes, maxRunes);
        this.addCapability(Status.FRIENDLY_TO_STORMVEIL_CASTLE_INHABITANT);
    }
    ...
    public ActionList allowableActions(Actor otherActor, String direction, GameMap map) {
        ...
        if (!otherActor.hasCapability(Status.FRIENDLY_TO_STORMVEIL_CASTLE_INHABITANT) && !otherActor.hasCapability(Status.PROTECTED)) {
